...
![Реализация с паттерном](ThirdLab.jpg)

### Диаграмма классов. Реализация без паттерна

![Реализация без паттерна](ThirdLabWithoutPattern.jpg)

### Выводы

При реализации игры с паттерном Правила покера и механизм сохранения были строго разделены, что дало высокую Инкапсуляцию. В то время как, реализация без паттерна наоборот перемешало и то, и другое, что сделало код мало разделяемым друг от друга.
