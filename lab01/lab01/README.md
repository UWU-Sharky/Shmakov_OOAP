...
# Выводы
   Завершив лабораторную, можно отметить такие преимущества работы singleton как: Глобальная точка данных и Однозначность реализации, которые помогли добиться удовлетворительных результатов.
